...
<%@page import="java.util.ArrayList"%>
    <%
    	List<EmpDTO> rList = (List<EmpDTO>) request.getAttribute("empList");
    %>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <!-- Custom Stylesheet -->
    <link href="../resource/plugins/tables/css/datatable/dataTables.bootstrap4.min.css" rel="stylesheet">
...
<body>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!-- 여기 div 태그로 이쁘게 수정하기 -->
                               <button type="button" onclick="location.href='/detail/addEmpInfo.do'">새직원 등록</button>
    ...
    ***********************************-->
    ...
    <script src="../resource/plugins/tables/js/jquery.dataTables.min.js"></script>
    <script src="../resource/plugins/tables/js/datatable/dataTables.bootstrap4.min.js"></script>
    <script src="../resource/plugins/tables/js/datatable-init/datatable-basic.min.js"></script>
