...
<head>
    ...
    <!-- Custom Stylesheet -->
    <link href="../resource/plugins/fullcalendar/css/fullcalendar.min.css" rel="stylesheet">
...
<body>
        ...
        <div class="nav-header">
            <div class="brand-logo">
                <a href="/main/index.do">
                    <b class="logo-abbr"><img src="../resource/images/logo.png" alt=""> </b>
                    <span class="logo-compact"><img src="../resource/images/logo-compact.png" alt=""></span>
                    <span class="brand-title">
                        <img src="../resource/images/logo-text.png" alt="">
                    </span>
                </a>
            </div>
        </div>
                    ...
                    <ul class="clearfix">
                                    ...
                                    <ul>
                                        <li class="notification-unread">
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="../resource/images/avatar/1.jpg" alt="">
                                        ...
                                        <li class="notification-unread">
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="../resource/images/avatar/2.jpg" alt="">
                                                <div class="notification-content">
                                        ...
                                        <li>
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="../resource/images/avatar/3.jpg" alt="">
                                                <div class="notification-content">
                                        ...
                                        <li>
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="../resource/images/avatar/4.jpg" alt="">
                                                <div class="notification-content">
                        ...
                        <li class="icons dropdown">
                            <div class="user-img c-pointer position-relative"   data-toggle="dropdown">
                                ...
                                <img src="../resource/images/user/1.png" height="40" width="40" alt="">
                            </div>
    ...
    ***********************************-->
    ...
    <script src="../resource/plugins/jqueryui/js/jquery-ui.min.js"></script>
    <script src="../resource/plugins/moment/moment.min.js"></script>
    <script src="../resource/plugins/fullcalendar/js/fullcalendar.min.js"></script>
    <script src="../resource/js/plugins-init/fullcalendar-init.js"></script>
