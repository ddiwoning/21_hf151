<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import="poly.dto.SalDTO"%>
<%@page import="static poly.util.CmmUtil.nvl"%>
<%@page import="java.util.List"%>
<%@page import="java.util.ArrayList"%>

    <%
    List<SalDTO> pList = (List<SalDTO>) request.getAttribute("rList");
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                       <!--  <div>
                                                        ...
                                                        <span><%=e.getSalary() %></span>
                                                    </td>
                                                    <td><!-- <i class="fa fa-circle-o text-success  mr-2"></i> Paid -->
                                                    	<span> <%=e.getAtt_time() %></span>
                                                    </td>
                                                    <td>
                                                        <span> <%=e.getOff_time() %> </span>
                                                    </td>
                                                    <td>
                                                        <span> <%=e.getDaily_sal() %> </span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                <%} %>
